...
module.exports = function(grunt) {
    ...
    function installDependencies(dir) {
        ...
        var npmTask = 'npm install --production --prefix ' + dir + ' from ' + process.cwd();
        var options = {
            cwd: process.cwd()
        };

        var exec = require('child_process').exec;
        console.log('running', npmTask);
        exec(npmTask, options, function(err, stdout, stderr) {
            if (err) {
    ...
    function distTask() {
        ...
        if (this.args[0] === 'prepare') {
            ...
            installDependencies(dir).then(function() {
